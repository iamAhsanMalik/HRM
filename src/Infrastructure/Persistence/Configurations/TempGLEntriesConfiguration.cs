...
//internal class TempGLEntriesConfiguration : IEntityTypeConfiguration<TempGLEntry>
//{
//    public void Configure(EntityTypeBuilder<TempGLEntry> builder)
//    {
//        builder.Property(t => t.TransactionId).UseIdentityColumn().IsRequired();
//        builder.Property(t => t.AccountTypeiCode).HasMaxLength(20);
//        builder.Property(t => t.AccountCode).HasMaxLength(50);
...
//        builder.Property(t => t.UserRefNo).HasMaxLength(50);
